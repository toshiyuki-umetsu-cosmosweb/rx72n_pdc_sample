...
***********************************************************************************************************************/
/* Mask for PDBF1 */
#define _FF_ELC_PORTGRP1_PDBF_MASK               (0xFFU)
/* Mask for PDBF2 */
#define _FF_ELC_PORTGRP2_PDBF_MASK               (0xFFU)
...
void R_Config_ELC_Create_UserInit(void);
