...
Macro definitions
***********************************************************************************************************************/
#define CMTW0_PCLK_COUNTER_DIVISION               (8)

/* Compare Match Constant Register (CMWCOR) */
#define _FFFFFFFE_CMTW0_CMWCOR_VALUE              (0xFFFFFFFEUL)
...
void R_Config_CMTW0_Create_UserInit(void);
